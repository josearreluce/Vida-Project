...
class TestQuery(unittest.TestCase):
	...
	def setUp(self):
		...
		self.sub_right_val = "select sub_sympt_1 from related_symptoms where sympt_id='sympt_1'"
		...
		self.sub_no_val = "select sub_sympt_120 from related symptoms where sympt_id='sympt_1'"
		self.valid_age = "select name from conditions where cond_id = 'cond_1' and age='18-40'"
		self.invalid_age = "select name from conditions where cond_id = 'cond_5' and age='18-40'"
		self.valid_time = "select name from conditions where cond_id = 'cond_1' and time='3-5'"
		self.invalid_time = "select name from conditions where cond_id = 'cond_5' and time='3-5'"
	...
	def test_sub_no_val(self):
		self.assertIsNone(self.cur.execute(self.sub_no_val))
